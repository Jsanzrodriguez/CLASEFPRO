        ...
        do{
            ...
            switch (opcion){
                case 1->{
                    ...
                    // en caso contrari te digo que error
                }
                case 2->{
                    controller.metodolistar();
                }
                case 3->{
                    System.out.println("Indica el correo que queres buscar");
                    String correo = scanner.next();
                ...
                case 4-> {
                    // no quiero que se repitan nombres, de ser asi, pide otro
                    ...
                    for (int i = 0; i < 5; i++) {
                        ...
                        do{
                            ...
                            correo = scanner.next();
                            if (controller.metodoBuscar(correo)){
                                System.out.println("El correo ya está");
                            }
